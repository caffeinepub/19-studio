import { a as useSearch, r as reactExports, j as jsxRuntimeExports, L as Link } from "./index-BITzmliG.js";
import { L as Layout, m as motion, S as Smartphone, P as Phone } from "./Layout-B_YkB73Q.js";
import { c as createLucideIcon, f as useAppointmentByReference, u as useServices, a as useStylists, S as Scissors, b as Button, B as Badge } from "./useBooking-Da3Ub56m.js";
import { a as CircleCheck, C as Calendar } from "./circle-check-q0aorir3.js";
import { C as Check } from "./check-DBlMKmBA.js";
      ...
      !isLoading && appointment && /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.div,
        {
          ...
          children: [
            ...
            service && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              motion.div,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-7 h-7 rounded-lg bg-green-500/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Smartphone, { className: "w-3.5 h-3.5 text-green-600" }) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-widest text-green-700 dark:text-green-400", children: "Payment Instructions" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-foreground mb-1", children: [
                    "Please send payment via",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-green-600 dark:text-green-400", children: "eSewa" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-2 mb-3", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "w-3.5 h-3.5 text-green-600 shrink-0" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-mono font-bold text-foreground tracking-wide", children: "+977 976-6466795" })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between bg-green-500/10 rounded-lg px-3 py-2", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "Amount to pay" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-base font-bold text-green-600 dark:text-green-400", children: [
                      "Rs. ",
                      Number(service.price)
                    ] })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] text-muted-foreground mt-2 leading-relaxed", children: "Screenshot your payment and show it at the salon. Booking is reserved once payment is received." })
                ]
              }
            ),
