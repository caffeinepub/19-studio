import { r as reactExports, j as jsxRuntimeExports, u as useNavigate } from "./index-BITzmliG.js";
import { M as MotionConfigContext, i as isHTMLElement, u as useConstant, a as PresenceContext, b as usePresence, c as useIsomorphicLayoutEffect, d as LayoutGroupContext, L as Layout, m as motion } from "./Layout-B_YkB73Q.js";
import { c as createLucideIcon, u as useServices, a as useStylists, d as useBookAppointment, b as Button, B as Badge, e as useAvailableSlots } from "./useBooking-Da3Ub56m.js";
import { C as Check } from "./check-DBlMKmBA.js";
import { W as Wallet } from "./wallet-C1FYDZRa.js";
/**
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 mb-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-lg bg-accent/15 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "h-4 w-4 text-accent", strokeWidth: 1.5 }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground font-display leading-none mb-0.5", children: "Pay via eSewa" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Complete payment after confirming your booking" })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5 text-sm", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground uppercase tracking-wider font-medium", children: "eSewa Account" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-accent font-display", children: "+977 976-6466795" })
                ] }),
                service && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground uppercase tracking-wider font-medium", children: "Amount Due" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-bold text-accent font-display", children: [
                    "Rs. ",
                    Number(service.price)
                  ] })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-3 leading-relaxed", children: "Send the exact amount to the eSewa number above. Use your name as the payment remark." })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
