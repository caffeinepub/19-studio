import { j as jsxRuntimeExports, c as cn, L as Link } from "./index-BITzmliG.js";
import { c as createLucideIcon, u as useServices, a as useStylists, B as Badge, b as Button, S as Scissors } from "./useBooking-Da3Ub56m.js";
import { S as Skeleton } from "./skeleton-ClNzS9g3.js";
import { L as Layout, m as motion, P as Phone } from "./Layout-B_YkB73Q.js";
import { W as Wallet } from "./wallet-C1FYDZRa.js";
import { C as Calendar, a as CircleCheck } from "./circle-check-q0aorir3.js";
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(
                      "a",
                      {
                        ...
                        children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-lg bg-accent/10 flex items-center justify-center shrink-0 group-hover:bg-accent/20 transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "h-4 w-4 text-accent", strokeWidth: 1.5 }) }),
                          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-medium uppercase tracking-widest text-muted-foreground leading-none mb-0.5", children: "Call Us" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-foreground font-display", children: "+977 976-6466795" })
                          ] })
                        ]
                      }
                    ),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5 px-4 py-3 rounded-xl bg-accent/10 border border-accent/20 backdrop-blur-sm", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-lg bg-accent/20 flex items-center justify-center shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Wallet, { className: "h-4 w-4 text-accent", strokeWidth: 1.5 }) }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[10px] font-medium uppercase tracking-widest text-muted-foreground leading-none mb-0.5", children: "Pay via eSewa" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-accent font-display", children: "+977 976-6466795" })
                      ] })
                    ] })
                  ]
                }
